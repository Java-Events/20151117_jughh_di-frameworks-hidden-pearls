package org.rapidpm.event.jughh.boondi.step004;
...
public class MainStep004Inject {
  ...
  public static class DemoModule {
    public DemoKlasse provideDemoKlasse() {
      return new DemoKlasse();
    }

    public SubDemo provideSubDemoKlasse() {
      return new SubDemoKlasse();
    }
  }
