...
package org.rapidpm.event.jughh.dagger2.business.subservice.impl_a;


import org.rapidpm.event.jughh.dagger2.business.subservice.BaseSubService;
...
public class SubServiceA extends BaseSubService {
  private final SubSubService service;
//  @Inject SubSubService service;
  @Inject
  public SubServiceA(final SubSubService service) {
